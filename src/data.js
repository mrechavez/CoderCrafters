...
export const plans = [
    {
        id: 1,
        name: 'Silver Package',
        desc: 'This package is for those who want to go the extra mile during their class',
        price: 29.99,
        features: [
            {feature: 'Extra time on tests/quizzes', available: true},
            {feature: 'A CoderCrafters swagbag full of vital tools', available: true},
            {feature: 'Additional hour of 1:1 instruction daily', available: true},
            {feature: 'Personal code audit from Owner Miles', available: true},
            {feature: 'Subscription to CoderCrafters Magazine', available: true},
            {feature: 'post-graduate Portfolio audit', available: false},
            {feature: 'Two additional hours of 1:1 instruction daily', available: false},
            {feature: '24/7 live support with a CoderCrafters Instructor', available: false},
            {feature: 'Meet&Greet with Elon Musk', available: false},
            {feature: 'A CoderCrafters branded Yeti', available: false},
            {feature: 'Lifetime consultation from any CoderCrafters instructor', available: false},
            {feature: 'Personal code audit from Owner Peter', available: false},
            {feature: 'Dinner and a movie with Elon Musk', available: false},
        ]
    },
    {
        id: 2,
        name: 'Gold Package',
        desc: 'This package is for those wanting to ensure post-graduate success',
        price: 49.99,
        features: [
            {feature: 'Extra time on tests/quizzes', available: true},
            {feature: 'A CoderCrafters swagbag full of vital tools', available: true},
            ...
            {feature: 'Personal code audit from Owner Miles', available: true},
            {feature: 'Subscription to CoderCrafters Magazine', available: true},
            {feature: 'post-graduate Portfolio audit', available: true},
            {feature: 'Two additional hours of 1:1 instruction daily', available: true},
            {feature: '24/7 live support with a CoderCrafters Instructor', available: true},
            {feature: 'Meet&Greet with Elon Musk', available: true},
            {feature: 'A CoderCrafters branded Yeti', available: false},
            {feature: 'Lifetime consultation from any CoderCrafters instructor', available: false},
            {feature: 'Personal code audit from Owner Peter', available: false},
            {feature: 'Dinner and a movie with Elon Musk', available: false},
    ...
    },
    {
        ...
        desc: 'For the elites seeking networking opportunities beyond graduation',
        price: 89.99,
        features: [
            {feature: 'Extra time on tests/quizzes', available: true},
            {feature: 'A CoderCrafters swagbag full of vital tools', available: true},
            ...
            {feature: '24/7 live support with a CoderCrafters Instructor', available: true},
            {feature: 'Meet&Greet with Elon Musk', available: true},
            {feature: 'A CoderCrafters branded Yeti', available: true},
            {feature: 'Lifetime consultation from any CoderCrafters instructor', available: true},
            {feature: 'Personal code audit from Owner Peter', available: true},
            {feature: 'Dinner and a movie with Elon Musk', available: true},
        ]
    },
]
